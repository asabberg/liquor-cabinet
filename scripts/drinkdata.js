...
//
            ...
            americansinglemalt: [
                { distillery: 'Copperworks', bottle: 'Single Cask - Color Cask', region: 'Washington, USA', ABV: '50%', age: '4 Years 9 Months', notes: 'Aged in a 200 Year Old Sherry Color Cask', occasion: '', retired: '', peated: '', cask: 'Sherry', other: '',  stamps:['asm.png']  },
                { distillery: 'Copperworks', bottle: 'Single Cask - Letterpress Amaro', region: 'Washington, USA', ABV: '50%', age: '7 Years 1 Months', notes: '1 Month Finish in Amaro Amorino Riserva Cask', occasion: '', retired: '', peated: '', cask: 'Amaro', other: '',stamps:['asm.png']   },
                { distillery: 'Copperworks', bottle: 'Single Cask - Pondera Cabernet', region: 'Washington, USA', ABV: '50%', age: '7 Years 7 Months', notes: '7 Month Finish in Pondera Cabernet Cask', occasion: '', retired: '', peated: '', cask: 'Wine', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Cask No. 3799 - Ratification Cask', region: 'Washington, USA', ABV: '55%', age: '8 Years', notes: '', occasion: '', retired: '', peated: '', cask: '', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Cask No. 5699 - Tequila Cask', region: 'Washington, USA', ABV: '52.6%', age: '9 Years', notes: '', occasion: '', retired: '', peated: '', cask: 'Tequila', other: '',stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Cask No. 6234 - Madeira Cask', region: 'Washington, USA', ABV: '65.6%', age: '', notes: '', occasion: '', retired: '', peated: '', cask: 'Dessert Wine', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Cask No. 6333 - Petite Syrah Cask', region: 'Washington, USA', ABV: '61.3%', age: '8 Years', notes: '', occasion: '', retired: '', peated: '', cask: 'Wine', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Cask No. 6744 - Mount Gay Rum Cask', region: 'Washington, USA', ABV: '53.9%', age: '9 Years', notes: '', occasion: '', retired: '', peated: 'yes', cask: 'Rum', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Cask No. 7637 - Rachel\'s Handfill', region: 'Washington, USA', ABV: '48.9%', age: '', notes: 'Pajarette Hogshead', occasion: '', retired: '', peated: 'Dessert Wine', cask: '', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Cask No. 7858 - Rachel\'s 2nd Handfill (Bottle 7)', region: 'Washington, USA', ABV: '52%', age: '9 Years', notes: 'White Port Cask Finish', occasion: '', retired: '', peated: '', cask: 'Dessert Wine', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Cask No. 8803 - Lucky Envelope Stout Finish Single Cask', region: 'Washington, USA', ABV: '56.3%', age: '5 Years', notes: 'Pilsen Malt', occasion: '', retired: '', peated: '', cask: 'Beer', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Cask No. 10741 - Asa\'s Handfill (Bottle 69)', region: 'Washington, USA', ABV: '63%', age: '', notes: 'Peated Malt &amp; Amarone Cask', occasion: '', retired: '', peated: 'yes', cask: 'Wine', other: '',  stamps:['asm.png','smokey.png'] },
                { distillery: 'Westland', bottle: 'Colere 1st Edition', region: 'Washington, USA', ABV: '50%', age: '4 Years', notes: 'Made with Skagit Valley Malting Alba Barley', occasion: 'Promotion to Director - March 2024', retired: '', peated: '', cask: '', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Colere 2nd Edition', region: 'Washington, USA', ABV: '50%', age: '4.9 Years', notes: 'Made with Talisman Barley', occasion: 'Promotion to Director - March 2024', retired: '', peated: '', cask: '', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Colere 3rd Edition', region: 'Washington, USA', ABV: '50%', age: '3.3 Years', notes: 'Made with Pilot Barley', occasion: 'First big solo outing after Sully was born - August 2023', retired: '', peated: '', cask: '', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Colere 4th Edition', region: 'Washington, USA', ABV: '50%', age: '5.9 Years', notes: 'Made with Fritz Barley, also known as NZ-151', occasion: '', retired: '', peated: '', cask: 'Rum', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Peat Week 7 - Escaped', region: 'Washington, USA', ABV: '60.8%', age: '7.4 Years', notes: 'Ex-Rum Cask #6732', occasion: '', retired: '', peated: 'yes', cask: '', other: '',  stamps:['asm.png','smokey.png']   },
                { distillery: 'Westland', bottle: 'Peat Week 8 - Grand Finale', region: 'Washington, USA', ABV: '54.5%', age: '7.1 Years', notes: '', occasion: '', retired: '', peated: 'yes', cask: '', other: '',  stamps:['asm.png','smokey.png']  },
                { distillery: 'Westland', bottle: 'Peat Week 2026 - Mossfire Mason', region: 'Washington, USA', ABV: '50%', age: '6 Years', notes: 'Heavily Peated - Bairds Peated Malt from Scotland', occasion: '', retired: '', peated: 'yes', cask: '', other: '',  stamps:['asm.png','smokey.png']  },
                { distillery: 'Westland', bottle: 'Peat Week 2026 - Augustus MacHuff', region: 'Washington, USA', ABV: '50%', age: '8 Years', notes: 'Lightly Peated - WA Skagit Malting, With WA Peat', occasion: '', retired: '', peated: 'yes', cask: '', other: '',  stamps:['asm.png','smokey.png']  },            
                { distillery: 'Westland', bottle: 'Cask Exchange - Black Raven Brewing', region: 'Washington, USA', ABV: '50%', age: '9 Years', notes: 'Finished in "Pour Les Oiseaux" Farmhouse Saison Casks. The  beer was brewed with Cherry Lambic wild yeast', occasion: '', retired: '', peated: '', cask: 'Beer', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Cask Exchange - Cloudburst Brewing', region: 'Washington, USA', ABV: '48.5%', age: '', notes: 'Old Tubthumper Barleywine Cask', occasion: '', retired: '', peated: '', cask: '', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Cask Exchange - Fast Penny Spirits', region: 'Washington, USA', ABV: '52.6%', age: '9 Years', notes: '', occasion: '', retired: '', peated: '', cask: 'Amaro', other: '', stamps:['asm.png']   },           
                { distillery: 'Westland', bottle: 'Cask Exchange - Greenwood Cider', region: 'Washington, USA', ABV: '50.1%', age: '', notes: '', occasion: '', retired: '', peated: '', cask: 'Cider', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Cask Exchange - Holy Mountain Brewing', region: 'Washington, USA', ABV: '50%', age: '6 Years', notes: 'Finished in American Strong Beer Casks that previously held Port', occasion: '', retired: '', peated: '', cask: 'Beer', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Cask Exchange - Sons Of Vancouver', region: 'Washington, USA', ABV: '55.3%', age: '', notes: 'Finished in No 82 Amaretto Casks', occasion: '', retired: '', peated: '', cask: 'Amaretto', other: '', stamps:['asm.png']   },             
                { distillery: 'Westland', bottle: 'Lost Lantern Single Cask - Peated ASM', region: 'Washington, USA', ABV: '54.9%', age: '9.99 Years', notes: '', occasion: '', retired: '', peated: 'yes', cask: '', other: '',  stamps:['asm.png','smokey.png']   },
                { distillery: 'Westland', bottle: 'Flagship', region: 'Washington, USA', ABV: '46%', age: '3.3 Years', notes: '', occasion: '', retired: '', peated: '', cask: '', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Garryaana 10th Edition', region: 'Washington, USA', ABV: '50%', age: '10 Years', notes: 'Primary Casks: First & Second Fill Garry Oak ', occasion: '', retired: '', peated: '', cask: '', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Sherry Wood', region: 'Washington, USA', ABV: '46%', age: '', notes: '', occasion: '', retired: '', peated: '', cask: 'Dessert Wine', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Solum 3rd Edition', region: 'Washington, USA', ABV: '50%', age: '4 Years', notes: 'Skagit Valley Malting Peated Malt - Using only Peat and Malt from the PNW', occasion: '', retired: '', peated: 'yes', cask: '', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Wine Cask Finish', region: 'Washington, USA', ABV: '46%', age: '5 Years', notes: '', occasion: '', retired: '', peated: '', cask: 'Wine', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Watchpost', region: 'Washington, USA', ABV: '42.5%', age: '8 Years', notes: '', occasion: '', retired: '', peated: '', cask: '', other: '', stamps:['asm.png']   },
                { distillery: 'Westland', bottle: 'Winter 2025', region: 'Washington, USA', ABV: '46%', age: '8 Years', notes: '', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Whiskey Del Bac', bottle: 'Distiller\'s Cut, Fall 2023', region: 'Arizona, USA', ABV: '58%', age: '', notes: 'Mesquite smoked and finished in Sauternes barrels &amp; Tawny Port barrels', occasion: '', retired: '', peated: 'yes', cask: 'Dessert Wine', other: '',  stamps:['asm.png','smokey.png']   },
                { distillery: 'Whiskey Del Bac', bottle: 'Dorado', region: 'Arizona, USA', ABV: '46%', age: '', notes: 'Mesquite smoked', occasion: '', retired: '', peated: 'yes', cask: '', other: '',  stamps:['asm.png','smokey.png']   },
                { distillery: 'Westward Whiskey', bottle: 'Lost Lantern Single Cask  - ASM Finished in Stout Casks', region: 'Oregon, USA', ABV: '68.5%', age: '', notes: '', occasion: '', retired: '', peated: '', cask: 'Beer', other: '', stamps:['asm.png']   },
                { distillery: 'St. George Spirits', bottle: 'Baller', region: 'California, USA', ABV: '47%', age: '', notes: 'Umeshu Finished', occasion: '', retired: '', peated: '', cask: 'Umeshu', other: '', stamps:['asm.png']   },
                { distillery: 'Virginia Distillery Co.', bottle: 'The Brewer\'s Coalition Goose Island Bourbon County Brand Stout Cask Finished', region: 'Virginia, USA', ABV: '50%', age: '', notes: '', occasion: '', retired: '', peated: '', cask: 'Beer', other: '', stamps:['asm.png']   },
                { distillery: 'Virginia Distillery Co.', bottle: 'The Brewer\'s Coalition Hardywood Gingerbread Stout Cask Finished', region: 'Virginia, USA', ABV: '50%', age: '', notes: 'One of Whiskey Advocates 2024 Most Interesting Whiskeys', occasion: '', retired: '', peated: '', cask: 'Beer', other: '', stamps:['asm.png']   },
            ...
            other: [
                ...
                { distillery: 'FEW', bottle: 'Chicago Smokeworks', region: 'Illinois, USA', ABV: '46.5%', age: '', notes: 'Cherrywood Smoked Malt', occasion: '', retired: '', peated: 'yes', cask: '', other: '',  stamps:['smokey.png']   },
                ...
                { distillery: 'Lost Lantern', bottle: 'Flame', region: 'Vermont, USA', ABV: '57%', age: '', notes: 'Blend of Sante Fe Spirits and Whiskey Del Bac', occasion: '', retired: '', peated: 'yes', cask: '', other: '',  stamps:['smokey.png']   },
        ...
        scotch: {
            scotch: [
//
                { distillery: 'Ardbeg', bottle: 'An Oa', region: 'Islay', ABV: '46.6%', age: '', notes: '', occasion: '', retired: '', peated: 'yes', cask: 'Dessert Wine', other: '',  stamps:['smokey.png']   },
                ...
                { distillery: 'Ardbeg', bottle: 'Spectacular', region: 'Islay', ABV: '46%', age: '', notes: 'Port Cask', occasion: '', retired: '', peated: 'yes', cask: 'Dessert Wine', other: '', stamps:['smokey.png']  },
                { distillery: 'Ardbeg', bottle: 'Ten Year', region: 'Islay', ABV: '46%', age: '10 Years', notes: '', occasion: '', retired: '', peated: 'yes', cask: '', other: '',  stamps:['smokey.png']   },
                { distillery: 'Ardbeg', bottle: 'Uigeadail', region: 'Islay', ABV: '54.2%', age: '', notes: '', occasion: '', retired: '', peated: 'yes', cask: '', other: '',  stamps:['smokey.png']   },
                { distillery: 'Bruichladdich', bottle: 'The Classic Laddie', region: 'Islay', ABV: '50%', age: '', notes: '', occasion: '', retired: '', peated: 'yes', cask: '', other: '',  stamps:['smokey.png']   },
        ...
        japanese: {
            japanese: [
                ...
                { distillery: 'Nikka', bottle: 'Yoichi - Peaty &amp; Salty', region: 'Hokkaido, Japan', ABV: '55%', age: 'NAS', notes: 'Bold peat smoke, briny maritime salinity, toasted oak, subtle sweetness', occasion: 'Aquired in Yokohama 2024', retired: '', peated: 'yes', cask: '', other: '',  stamps:['smokey.png']   },
        ...
        restofworld: {
            world: [
                ...
                { distillery: 'Odd Society', bottle: 'Burns Bog', region: 'Vancouver, Canada', ABV: '46%', age: '', notes: 'Canadian Smoked Malt Whiskey', occasion: '', retired: '', peated: 'yes', cask: '', other: '',  stamps:['smokey.png']   },              
            ]
        },    
        unicorns: {
            unicorn:[    
                { distillery: 'Bainbridge Organic Distillers', bottle: 'Yama | Mizunara Cask Single Grain Whiskey', region: 'Bainbridge Island, WA', ABV: '43%', Age: '', notes: 'Aromatic sandalwood, tropical flowers, star anise, joss incense; flavors of nutmeg, clove, pear, marzipan, toasted coconut, yuzu; finishes with fading spice, honey, and oak', occasion: 'Rachel\'s Retirement Gift 2023', retired: '', peated: '', cask: 'Mizunara', other: '',  stamps:['unicorn.png']      },
                { distillery: 'Akkeshi', bottle: 'Hakuro - 2023 Release', region: 'Hokkaido, Japan', ABV: '55%', Age: '', notes: 'Hakuro is the heart of September, the 8th through the 22nd, when dewy summer nights embrace the last of summer’s vibrance', occasion: 'Potty Trained Sully + 10th Wedding Anniversary August 2025', retired: '', peated: 'yes', cask: 'Mizunara', other: '',  stamps:['smokey.png','unicorn.png']     },
                { distillery: 'Kavalan', bottle: 'Soloist Vinho Barrique Cask Strength', region: 'Taiwan', ABV: '58.6%', age: '', notes: 'Cask W170113031A', occasion: 'Denys Quit - July 2025', retired: '', peated: '', cask: 'Wine', other: '',  stamps:['unicorn.png']     },
                { distillery: 'Kavalan', bottle: 'Soloist Solist ex-Bourbon Cask Strength', region: 'Taiwan', ABV: '58.3%', age: '', notes: '', occasion: '', retired: '', peated: '', cask: '', other: '',  stamps:['unicorn.png']     },
                { distillery: 'Michter\'s', bottle: 'Toasted Barrel Bourbon', region: 'Kentucky, USA', ABV: '45.7%', Age: '', notes: '', occasion: 'Minos ASR - November 2024', retired: '', peated: '', cask: 'Toasted', other: '',  stamps:['unicorn.png']     },
                { distillery: 'Suntory', bottle: 'Hibiki 17', region: 'Japan', ABV: '43%', Age: '17 Years', notes: '', occasion: 'Christmas Present', retired: '', peated: '', cask: '', other: '',  stamps:['unicorn.png']     },
            ]
       }
