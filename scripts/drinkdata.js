...
//
            ...
            americansinglemalt: [
                ...
                { distillery: 'Westland', bottle: 'Cask No. 5699 - Tequila Cask', region: 'Washington, USA', ABV: '52.6%', age: '9 Years', notes: '', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Westland', bottle: 'Cask No. 6234 - Madeira Cask', region: 'Washington, USA', ABV: '65.6%', age: '', notes: '', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Westland', bottle: 'Cask No. 6333 - Petite Syrah Cask', region: 'Washington, USA', ABV: '61.3%', age: '8 Years', notes: '', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Westland', bottle: 'Cask No. 6744 - Mount Gay Rum Cask', region: 'Washington, USA', ABV: '53.9%', age: '9 Years', notes: '', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Westland', bottle: 'Cask No. 7637 - Rachel\'s Handfill', region: 'Washington, USA', ABV: '48.9%', age: '', notes: 'Pajarette Hogshead', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                ...
                { distillery: 'Westland', bottle: 'Cask No. 8803 - Lucky Envelope Stout Finish Single Cask', region: 'Washington, USA', ABV: '56.3%', age: '5 Years', notes: 'Pilsen Malt', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Westland', bottle: 'Cask No. 10741 - Asa\'s Handfill (Bottle 69)', region: 'Washington, USA', ABV: '63%', age: '', notes: 'Peated Malt &amp; Amarone Cask', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                ...
                { distillery: 'Westland', bottle: 'Colere 4th Edition', region: 'Washington, USA', ABV: '50%', age: '5.9 Years', notes: 'Made with Fritz Barley, also known as NZ-151', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Westland', bottle: 'Peat Week 7 - Escaped', region: 'Washington, USA', ABV: '60.8%', age: '7.4 Years', notes: 'Ex-Rum Cask #6732', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Westland', bottle: 'Peat Week 8 - Grand Finale', region: 'Washington, USA', ABV: '54.5%', age: '7.1 Years', notes: '', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                ...
                { distillery: 'Westland', bottle: 'Cask Exchange - Black Raven Brewing', region: 'Washington, USA', ABV: '50%', age: '9 Years', notes: 'Finished in "Pour Les Oiseaux" Farmhouse Saison Casks. The  beer was brewed with Cherry Lambic wild yeast', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                ...
                { distillery: 'Westland', bottle: 'Cask Exchange - Fast Penny Spirits', region: 'Washington, USA', ABV: '52.6%', age: '9 Years', notes: '', occasion: '', retired: '', peated: '', cask: '', other: ''  },           
                { distillery: 'Westland', bottle: 'Cask Exchange - Greenwood Cider', region: 'Washington, USA', ABV: '50.1%', age: '', notes: '', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Westland', bottle: 'Cask Exchange - Holy Mountain Brewing', region: 'Washington, USA', ABV: '50%', age: '6 Years', notes: 'Finished in American Strong Beer Casks that previously held Port', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Westland', bottle: 'Cask Exchange - Sons Of Vancouver', region: 'Washington, USA', ABV: '55.3%', age: '', notes: 'Finished in No 82 Amaretto Casks', occasion: '', retired: '', peated: '', cask: '', other: ''  },             
                { distillery: 'Westland', bottle: 'Lost Lantern Single Cask - Peated ASM', region: 'Washington, USA', ABV: '54.9%', age: '9.99 Years', notes: '', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                ...
                { distillery: 'Westland', bottle: 'Sherry Wood', region: 'Washington, USA', ABV: '46%', age: '', notes: '', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Westland', bottle: 'Solum 3rd Edition', region: 'Washington, USA', ABV: '50%', age: '4 Years', notes: 'Skagit Valley Malting Peated Malt - Using only Peat and Malt from the PNW', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Westland', bottle: 'Wine Cask Finish', region: 'Washington, USA', ABV: '46%', age: '5 Years', notes: '', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                ...
                { distillery: 'Whiskey Del Bac', bottle: 'Distiller\'s Cut, Fall 2023', region: 'Arizona, USA', ABV: '58%', age: '', notes: 'Mesquite smoked and finished in Sauternes barrels &amp; Tawny Port barrels', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Whiskey Del Bac', bottle: 'Dorado', region: 'Arizona, USA', ABV: '46%', age: '', notes: 'Mesquite smoked', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Westward Whiskey', bottle: 'Lost Lantern Single Cask  - ASM Finished in Stout Casks', region: 'Oregon, USA', ABV: '68.5%', age: '', notes: '', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'St. George Spirits', bottle: 'Baller', region: 'California, USA', ABV: '47%', age: '', notes: 'Umeshu Finished', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Virginia Distillery Co.', bottle: 'The Brewer\'s Coalition Goose Island Bourbon County Brand Stout Cask Finished', region: 'Virginia, USA', ABV: '50%', age: '', notes: '', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Virginia Distillery Co.', bottle: 'The Brewer\'s Coalition Hardywood Gingerbread Stout Cask Finished', region: 'Virginia, USA', ABV: '50%', age: '', notes: 'One of Whiskey Advocates 2024 Most Interesting Whiskeys', occasion: '', retired: '', peated: '', cask: '', other: ''  },
            ...
            other: [
                ...
                { distillery: 'FEW', bottle: 'Chicago Smokeworks', region: 'Illinois, USA', ABV: '46.5%', age: '', notes: 'Cherrywood Smoked Malt', occasion: '', retired: '', peated: '', cask: '', other: ''  },
        ...
        scotch: {
            scotch: [
//
                { distillery: 'Ardbeg', bottle: 'An Oa', region: 'Islay', ABV: '46.6%', age: '', notes: '', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                ...
                { distillery: 'Ardbeg', bottle: 'Spectacular', region: 'Islay', ABV: '46%', age: '', notes: 'Port Cask', occasion: '', retired: '', peated: 'yes', cask: '', other: '', stamps:['smokey2.png']  },
                { distillery: 'Ardbeg', bottle: 'Ten Year', region: 'Islay', ABV: '46%', age: '10 Years', notes: '', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Ardbeg', bottle: 'Uigeadail', region: 'Islay', ABV: '54.2%', age: '', notes: '', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Bruichladdich', bottle: 'The Classic Laddie', region: 'Islay', ABV: '50%', age: '', notes: '', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                ...
                { distillery: 'Glenmorangie ', bottle: 'A Tale of Spices', region: 'Highlands', ABV: '46%', age: '', notes: 'A blend finished in Moroccan Red Wine, New Charred Oak, Shaved and Toasted Red Wine and PX Sherry Casks', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Chivas Regal', bottle: 'Mizunara', region: 'Scotland', ABV: '40%', age: '12 Years', notes: '', occasion: '', retired: '', peated: '', cask: '', other: ''  },
        ...
        japanese: {
            japanese: [
                { distillery: 'Ichiro\'s Malt', bottle: 'MWR - Mizunara Wood Reserve', region: 'Japan', ABV: '46%', age: '', notes: '', occasion: 'Yokohama Trip Dec \'24', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Ichiro\'s Malt', bottle: 'Wine Wood Reserve', region: 'Japan', ABV: '46%', age: '', notes: '', occasion: 'Yokohama Trip Dec \'24', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Nikka', bottle: 'Miyagikyo Single Malt', region: 'Miyagi, Japan', ABV: '45%', age: '', notes: '', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Nikka', bottle: 'Yoichi - Peaty &amp; Salty', region: 'Hokkaido, Japan', ABV: '55%', age: 'NAS', notes: 'Bold peat smoke, briny maritime salinity, toasted oak, subtle sweetness', occasion: 'Aquired in Yokohama 2024', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Nikka', bottle: 'Yoichi - Sherry &amp; Sweet', region: 'Hokkaido, Japan', ABV: '55%', age: 'NAS', notes: 'Rich dried fruit, dark chocolate, nutty sweetness, hints of spice', occasion: 'Aquired in Yokohama 2024', retired: '', peated: '', cask: '', other: ''  },
        ...
        restofworld: {
            world: [
                { distillery: 'Jameson', bottle: 'Stout Edition', region: 'Ireland', ABV: '40%', age: '', notes: 'Stout Cask Finish', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Odd Society', bottle: 'Bomber Brewing Community Collaboration', region: 'Vancouver, Canada', ABV: '50%', age: '', notes: 'Double IPA Whiskey', occasion: '', retired: '', peated: '', cask: '', other: ''  },
                { distillery: 'Odd Society', bottle: 'Burns Bog', region: 'Vancouver, Canada', ABV: '46%', age: '', notes: 'Canadian Smoked Malt Whiskey', occasion: '', retired: '', peated: '', cask: '', other: ''  },              
            ]
        },    
        unicorns: {
            unicorn:[    
