...
//
            ...
            americansinglemalt: [
                ...
                { distillery: 'Westland', bottle: 'Cask No. 6058 - JD Maple Wood Cask', region: 'Washington, USA', ABV: '53.4%', age: '9 Years', notes: 'Finished in Jack Daniels Maple Wood Casks', occasion: '2026 Vintage Cask Market', retired: '', peated: '', cask: 'Maple', other: ''   },
                ...
                { distillery: 'Westland', bottle: 'Cask No. 7858 - Rachel\'s 2nd Handfill (Bottle 7)', region: 'Washington, USA', ABV: '52%', age: '9 Years', notes: 'White Port Cask Finish', occasion: '', retired: '', peated: '', cask: 'Dessert Wine', other: ''   },
                ...
                { distillery: 'Westland', bottle: 'Cask No. 10741 - Asa\'s Handfill (Bottle 69)', region: 'Washington, USA', ABV: '63%', age: '', notes: 'Peated Malt &amp; Amarone Cask', occasion: '', retired: '', peated: 'yes', cask: 'Wine', other: '' },
                { distillery: 'Westland', bottle: 'Cask No. 10882 - Peated Marsala Cask', region: 'Washington, USA', ABV: '51.4%', age: '8 Years', notes: 'Peated Malt &amp; Marsala Cask', occasion: '2026 Vintage Cask Market', retired: '', peated: 'yes', cask: 'Wine', other: '' },
                { distillery: 'Westland', bottle: 'Celebrious', region: 'Washington, USA', ABV: '52.7%', age: '4.6 Years', notes: '8 Month Finish in Tequila Casks', occasion: '2026 Vintage Cask Market', retired: '', peated: '', cask: 'Tequila', other: ''   },
                ...
                { distillery: 'Westland', bottle: 'Cask Exchange - Fair Isle', region: 'Washington, USA', ABV: '', age: '', notes: 'A Saison cask from Fair Isle, where Pjotr was made using Purple Egyptian barley', occasion: '', retired: '', peated: '', cask: '', other: ''   },
                ...
                { distillery: 'Westland', bottle: 'Cask Exchange - Lucky Envelope', region: 'Washington, USA', ABV: '50%', age: '5.75 Years', notes: 'Finished in Lucky Envelope Double Happiness Imperial Porter Casks', occasion: '2026 Vintage Cask Market', retired: '', peated: '', cask: 'Beer', other: ''   },             
                ...
                { distillery: 'Westland', bottle: 'Sport Dram 2018 - Green Grip', region: 'Washington, USA', ABV: '46%', age: '', notes: '', occasion: '2026 Vintage Cask Market', retired: '', peated: 'yes', cask: '', other: ''   },
