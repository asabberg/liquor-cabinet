...
//
                ...
                { distillery: 'Old Boudreau&#x27;s Insanely Small Batch', bottle: '2019', region: '', ABV: '50.0%', Age: '', notes: 'Sherry &amp; Angostura Bitters Barrel Finished', occasion: '', retired: ''  },
            ...
            rye: [
                ...
                { distillery: 'WhistlePig', bottle: '12 Old World Rye', region: 'Vermont, USA', ABV: '43.0%', Age: '', notes: 'Rich fruit and spice notes, including rye spice, apricots, plums, raisins, dates, honey, dark chocolate, winter fruit, caramel, and vanilla', occasion: '', retired: ''  },
                { distillery: 'Wildwood Spirits Co', bottle: 'Rendition', region: 'Washington, USA', ABV: '45.0%', Age: '', notes: '', occasion: '', retired: ''  },
            ...
            americansinglemalt: [
                ...
                { distillery: 'Westland', bottle: 'Colere 4th Edition', region: 'Washington, USA', ABV: '50.0%', Age: '', notes: 'Fritz barley, also known as NZ-151', occasion: '', retired: ''  },
                { distillery: 'Westland', bottle: 'Colere 3rd Edition', region: 'Washington, USA', ABV: '50.0%', Age: '', notes: 'Pilot Barley', occasion: 'Director Whiskey', retired: ''  },
                { distillery: 'Westland', bottle: 'Colere 2nd Edition', region: 'Washington, USA', ABV: '50.0%', Age: '', notes: 'Talisman Barley', occasion: 'Director Whiskey', retired: ''  },
                { distillery: 'Westland', bottle: 'Colere 1st Edition', region: 'Washington, USA', ABV: '50.0%', Age: '', notes: 'Skagit Valley Malting Alba Barley', occasion: 'Director Whiskey', retired: ''  },
                ...
                { distillery: 'Westland', bottle: 'Holy Mountain Cask Exchange', region: 'Washington, USA', ABV: '50.0%', Age: '', notes: 'Finished in American Strong Beer Casks that previously held Port (35 months)', occasion: '', retired: ''  },
                ...
                { distillery: 'Westland', bottle: 'Cask No. 6744 - Mount Gay Rum', region: 'Washington, USA', ABV: '53.9%', Age: '', notes: '', occasion: '', retired: ''  },
                { distillery: 'Westland', bottle: 'Cask No. 3799 - Ratification Cask', region: 'Washington, USA', ABV: '55.0%', Age: '', notes: '', occasion: '', retired: ''  },
                ...
                { distillery: 'Westland', bottle: 'Wine Cask Finish', region: 'Washington, USA', ABV: '46.0%', Age: '', notes: '', occasion: '', retired: ''  },
            ...
            other: [
                ...
                { distillery: 'Deschutes x Bend Distillery', bottle: 'Black Butte Whiskey', region: 'Oregon, USA', ABV: '47.0%', Age: '', notes: '', occasion: '', retired: ''  },
...
//
                    ...
                    { distillery: 'Chivas Regal', bottle: 'Mizunara', region: 'Scotland', ABV: '40.0%', Age: '', notes: '', occasion: '', retired: ''  },
]
        },
        japanese: {
            all: [
                { distillery: 'Ichiro&#x27;s Malt', bottle: 'MWR', region: 'Japan', ABV: '46.0%', Age: '', notes: '', occasion: 'Yokohama Trip Dec &#x27;24', retired: ''  },
                { distillery: 'Ichiro&#x27;s Malt', bottle: 'Wine Wood Reserve', region: 'Japan', ABV: '46.0%', Age: '', notes: '', occasion: 'Yokohama Trip Dec &#x27;24', retired: ''  },
                { distillery: 'Nikka', bottle: 'Yoichi - Peaty &amp; Salty', region: 'Hokkaido, Japan', ABV: '55.0%', Age: '', notes: 'Bold peat smoke, briny maritime salinity, toasted oak, subtle sweetness', occasion: 'Aquired in Yokohama 2024', retired: ''  },
                { distillery: 'Nikka', bottle: 'Yoichi - Woody &amp; Vanillic', region: 'Hokkaido, Japan', ABV: '55.0%', Age: '', notes: 'Soft vanilla on the nose, woody on the palate, hints of bourbon sweetness, cocoa, and malt', occasion: 'Aquired in Yokohama 2024', retired: ''  },
                { distillery: 'Nikka', bottle: 'Yoichi - Sherry &amp; Sweet', region: 'Hokkaido, Japan', ABV: '55.0%', Age: '', notes: 'Rich dried fruit, dark chocolate, nutty sweetness, hints of spice', occasion: 'Aquired in Yokohama 2024', retired: ''  },
    ...
    others: {
            ...
            rum: [
                { distillery: 'Koloa', bottle: '12 Barrel Select', region: '', ABV: '46.0%', Age: '', notes: '', occasion: '', retired: ''  },            ],
            brandy: [
    ...
    hardcore: {
        all: [
            { distillery: 'Bainbridge Organic Distillers', bottle: 'Yama | Mizunara Cask Single Grain Whiskey', region: 'Bainbridge Island, WA', ABV: '43.0%', Age: '', notes: 'Aromatic sandalwood, tropical flowers, star anise, joss incense; flavors of nutmeg, clove, pear, marzipan, toasted coconut, yuzu; finishes with fading spice, honey, and oak', occasion: 'Retirement Gift ‘23', retired: ''  },
            { distillery: 'Michter&#x27;s', bottle: 'Toasted Barrel Bourbon', region: 'Kentucky, USA', ABV: '45.7%', Age: '', notes: '', occasion: '', retired: ''  },
            { distillery: 'Suntory', bottle: 'Hibiki 17', region: 'Japan', ABV: '43.0%', Age: '', notes: '', occasion: '', retired: ''  },
                    ]
    },
